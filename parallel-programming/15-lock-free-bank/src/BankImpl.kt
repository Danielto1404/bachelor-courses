...
class BankImpl(override val numberOfAccounts: Int) : Bank {
    ...
    override fun withdraw(index: Int, amount: Long): Long {
        ...
        while (true) {
            ...
            val newAccountAmount = Account(currentAccount.amount - amount)
            if (accounts[index].compareAndSet(currentAccount, newAccountAmount)) return newAccountAmount.amount
        }
    }
